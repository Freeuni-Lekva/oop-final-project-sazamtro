-- Remove the USE statement (H2 doesn't need/use it)
-- Removed ENUM types (H2 doesn't support ENUM), replaced with VARCHAR
-- Everything else is kept the same or adjusted to H2-compatible types
